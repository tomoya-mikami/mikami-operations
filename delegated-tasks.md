...
| T-020 | I-009/I-013 eBay業務自動化 Phase1整理 | Alf / 正式作業台 | 進行中 | 稼働中GAS自動化12ファイル、詳細トリガー、絶対ルール、未完了ダッシュボード要望を正本化し、再構築対象と残す機能を整理する | `ebay-phase1-audit.md`, `ebay-phase1-system-map.md`, `ebay-phase1-test-plan.md`, `ebay-phase1-improvement-plan.md`, `ebay-automation-phase1-summary.md`, `ebay-phase1-startup-tasks.md`, `alf-phase1-gas-readonly-check-request.md`, `tool-inventory.md`, `projects.md` | Alfで本番GASを読み取り専用確認する。削除・変更・実行は禁止。12ファイル、トリガー、Script Propertiesキー名、不要候補4ファイル、ダッシュボード/メニュー有無を確認する | 一部済 |
