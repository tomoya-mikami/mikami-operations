...
| P-013 | 外注管理・報酬計算 | 相談準備 | 外注スタッフとのやり取り、作業管理、報酬計算、管理シート、ツール化を整理する | `outsourcing-ops-chat-prompt.md` | 専用チャット `外注管理・報酬計算 相談` を作り、現状・課題・管理項目を整理する |
...
7. P-013: 外注管理・報酬計算の専用チャットで、作業管理シートと報酬計算フローを相談する。
